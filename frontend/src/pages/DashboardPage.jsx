    ...
    <>
      <div className="flex flex-col items-center justify-center min-h-screen overflow-hidden">
        ...
        <div className={`h-screen w-full ease-in-out duration-300`}>
          <div className={`flex justify-end h-12 shadow-md`}>
            <div className="flex space-x-4 pr-4 items-center">
              <button
                className="hover:scale-125 hover:cursor-pointer ease-in-out duration-300"
                onClick={handleNavigateToFileUploadPage}
              >
